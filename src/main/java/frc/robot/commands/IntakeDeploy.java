...
public class IntakeDeploy extends Command {
    ...
    private Double climberRightSup;
    private Double climberLeftSup;
  
  
  public IntakeDeploy(Climber s_Climber, Double climberRightSup, Double climberLeftSup) {
  ...
  public void execute() {
    /* Get Values, Deadband*/
        double climberRight = climberRightSup;
        double climberLeft = climberLeftSup;

...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double driveKP = 1.5; //.12TODO: This must be tuned to specific robot
        public static final double driveKI = 0.0;
        public static final double driveKD = 0.0;
        public static final double driveKF = 0.0;

        /* Drive Motor Characterization Values From SYSID */
        public static final double driveKS = 0.12872; //.32TODO: This must be tuned to specific robot
        public static final double driveKV = 2.3014;//1.51
        public static final double driveKA = 0.55493;//.27

        /* Swerve Profiling Values */
        /** Meters per Second */
        public static final double maxSpeed = 4.5; //4.5 original value
        /** Radians per Second */
        public static final double maxAngularVelocity = (2 * Math.PI)*1.15; //10.0 original value
    ...
    public static final class ShooterConstants {
        ...
        public static final double shooter_FF = 0.000186;
        public static final int top_shooterVelo = -510; // -800, -550
        public static final int bottom_shooterVelo = -1720; // -2400, 1800
        public static final int combined_shooterVelo = -4000; // -2400
        public static final int rev_shooterVelo = -800; // -800
        public static final double ampDelayTime = 0.6; //in seconds
    }
    public static final class IndexerConstants {
        public static final int topIndexMotorID = 10;
        public static final int auxIndexMotorID = 60;
        public static final int stacklightID = 0;
        public static final double index_P = .0001;//.00005
        public static final double index_I = 0.0;
        public static final double index_D = 0.0;
        public static final double index_FF = 0.00019;//.000015
        public static final int photoswitchID = 4;
        public static final int indexVelo = 3600;
        public static final int indexVeloAmp = 1200;
        public static final int indexVeloSpeaker = 1520;
        public static final int IndexVeloFWD = 1500;
        public static final int indexVeloREV = -1500;
        public static final int indexVeloAux = 7000;

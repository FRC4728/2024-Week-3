...
public class Indexer extends SubsystemBase{
    ...
    CANSparkMax m_auxIndexMotor = new CANSparkMax(Constants. IndexerConstants.auxIndexMotorID,MotorType.kBrushless);
    ...
    private SparkPIDController m_auxIndexerPIDContoller;
    ...
    public Indexer() {
        ...
        m_auxIndexMotor.restoreFactoryDefaults();

        m_TopIndexerPIDController = m_topIndexMotor.getPIDController();
        m_auxIndexerPIDContoller = m_auxIndexMotor.getPIDController();

        m_TopIndexerPIDController.setP(s_kP);
        m_auxIndexerPIDContoller.setP(s_kP);

        m_TopIndexerPIDController.setI(s_kI);
        m_auxIndexerPIDContoller.setI (s_kI);

        m_TopIndexerPIDController.setD(s_kD);
        m_auxIndexerPIDContoller.setD(s_kD);

        m_TopIndexerPIDController.setFF(s_kFF);
        m_auxIndexerPIDContoller.setFF(s_kFF);
        ...
        m_auxIndexerPIDContoller.setOutputRange(Constants.minMaxOutputConstants.kMinOutput, Constants.minMaxOutputConstants.kMaxOutput);
    ...
    public void runIndex(int Velo, int VeloAux){
        //set the velocity of the motor based on input value
            if (photoswitch) {
                stacklight = true;
                //new WaitCommand(5);
                m_TopIndexerPIDController.setReference(0,CANSparkBase.ControlType.kVelocity);
                m_auxIndexerPIDContoller.setReference(-Velo,CANSparkBase.ControlType.kVelocity);
            }
            else {
                m_TopIndexerPIDController.setReference(Velo,CANSparkBase.ControlType.kVelocity);
                m_auxIndexerPIDContoller.setReference(VeloAux,CANSparkBase.ControlType.kVelocity);
                stacklight = false;
            }
    ...
    public void runIndexFWD(int VeloFWD){
        //set the velocity of the motor based on input value
            ...
            m_auxIndexerPIDContoller.setReference(VeloFWD,CANSparkBase.ControlType.kVelocity);
    ...
    public void runIndexREV(int VeloREV){
        //set the velocity of the motor based on input value
            ...
            m_auxIndexerPIDContoller.setReference(VeloREV,CANSparkBase.ControlType.kVelocity);
